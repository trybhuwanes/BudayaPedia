...
<body class="m-0 font-poppins text-base antialiased font-normal leading-default bg-gray-50 text-slate-500">
    ...
    <main class="bg-brown-50 ease-soft-in-out xl:ml-68.5 relative max-h-full transition-all duration-200">
        <!-- cards -->
            ...
            @csrf
              ...
              <div class="flex flex-wrap -mx-3 mb-2">
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                  ...
                  <input class="block w-full text-sm text-black border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="pict_sejarah" type="file" name="pict_sejarah">
              ...
              <div class="flex flex-wrap -mx-3 mb-2">
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                  ...
                  <input class="block w-full text-sm text-black border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="pict_baju_adat" type="file" name="pict_baju_adat">
                  <p class="mt-1 text-sm text-black" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p> 
              ...
              <div class="flex flex-wrap -mx-3 mb-2">
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                  ...
                  <input class="block w-full text-sm text-black border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="pict_rumah_adat" type="file" name="pict_rumah_adat">
                  <p class="mt-1 text-sm text-black" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
              ...
              <div class="flex flex-wrap -mx-3 mb-2">
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                  ...
                  <input class="block w-full text-sm text-black border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="pict_lagu_daerah" type="file" name="pict_lagu_daerah">
                  <p class="mt-1 text-sm text-black" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
              ...
              <div class="flex flex-wrap -mx-3 mb-2 pb-6">
                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                  ...
                  <input class="block w-full text-sm text-black border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="pict_senjata" type="file" name="pict_senjata">
                  <p class="mt-1 text-sm text-black" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
